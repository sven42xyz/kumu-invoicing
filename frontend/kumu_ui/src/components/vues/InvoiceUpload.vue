<template>
    <div id="Main">
        ...
        <Card
            style="width: 47%; height: 5.5vmin; margin-left: 2%; float:left; margin-top: 1%; background-color: whitesmoke; border-radius: 1vmin;">
        ...
        <Card
            style="width: 47%; height: 5.5vmin; margin-right: 2%; float:right; margin-top: 1%; background-color: whitesmoke; border-radius: 1vmin;">
            hihi
        </Card>
        <p
            style="width: 47%; margin-left: 2%; float:left; margin-top: 1%; background-color: whitesmoke; border-radius: 1vmin;">
            <DataTable v-model:filters="filters" :value="products" dataKey="id" filterDisplay="row" stripedRows
                scrollable scrollHeight="73vmin" style="color: black; border-radius: 0%; height: 80%">
                <ColumnColumn field="Rechnungsnummer" filterField="Rechnungsnummer" header="Rechnungsnummer"
                ...
                <ColumnColumn field="Partner" filterField="Partner" header="Partner"
                    style="color: black; font-size: 1.75vmin; padding: 1vmin">
                ...
                <ColumnColumn field="Datum" filterField="Datum" header="Datum"
                    style="color: black; font-size: 1.75vmin; padding: 1vmin">
                ...
                <ColumnColumn field="Summe" filterField="Summe" header="Summe"
                    style="color: black; font-size: 1.75vmin; padding: 1vmin">
        ...
        <Card
            style="width: 47%; height: 77.5%; margin-right: 2%; float:right; margin-top: 1%; background-color: whitesmoke; border-radius: 1vmin;">
            hi
        </Card>
    </div>
</template>
    ...
    data() {
        return {
            ...
            items: [
                ...
                { type: 'label', label: 'Eingang', url: '/inbound', icon: '' },
                { type: 'label', label: 'Ausgang', url: '/outbound', icon: '' },
                { type: 'label', label: 'Stammdaten', url: '/contacts', icon: '' },
